...
class EachResult extends React.Component{
    filterPrice(price){
        ...
        if(!price){
            ...
            return 'Price: $ ' + price.listPrice.amount
    ...
    render (){
        ...
        return(
            <div id='each-result-box'>
                ...
                <p className='details child' id='author'>Author: {this.props.author ? this.props.author : 'author not available'}</p>
                <p className='details child'>
                    {this.filterPrice(this.props.price)} </p>
                    
                <div className='details child' id='description'>
                    {!this.props.description ? 'description not available' 
